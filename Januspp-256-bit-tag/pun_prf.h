#ifndef JANUSPP256_PUN_PRF_H
#define JANUSPP256_PUN_PRF_H
...
public:
    ...
    unsigned char *get_data_ptr() { return this->tag_data_ptr; }
    ...
    inline size_t size() const { return 4 * sizeof(long long); }
...
struct PuncturedKey
{
    ...
    std::vector<std::array<unsigned char, 16>> keydata;
