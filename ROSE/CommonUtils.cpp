...
int PRF_F(unsigned char *out, const unsigned char *key, const string &keyword, const std::string &id, OP op)
{
    ...
    HMAC_Update(ctx, (const unsigned char *) id.c_str(), id.size());
